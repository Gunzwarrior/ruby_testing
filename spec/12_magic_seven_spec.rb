...
describe MagicSeven do
  ...
  describe '#subtract_four' do
    context 'when the previous test is 16' do
      it 'returns 12' do
        previous_step = 16
  ...
  describe '#subtract_random_number' do
    ...
    context 'when previous step is 6 and random number is 8' do
      it 'returns -2' do
        previous_step = 6
  ...
  describe '#play' do
    ...
    context 'when the random number is 99' do
      # remove the 'x' before running this test
      it 'will return 7' do
        my_game = described_class.new(99)
        result = my_game.play
        expect(result).to eq(7)
      end
    end
    ...
    context 'when the random number is 42' do
      # remove the 'x' before running this test
      it 'will return 7' do
        my_game = described_class.new(42)
        result = my_game.play
        expect(result).to eq(7)
      end
    end
